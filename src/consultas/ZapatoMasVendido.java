 ...
 * @author HP-Alexis
 */
public class ZapatoMasVendido extends javax.swing.JFrame {

     DefaultTableModel modeloZapato=new DefaultTableModel();
     
    public ZapatoMasVendido() {
        initComponents();
        setVisible(true);
        ...
        ZapatoMasVendidoZ zmv = new ZapatoMasVendidoZ();
        zmv.iniciarModeloTabla(modeloZapato, tableZapatoMasVendido);
    ...
    private void initComponents() {
        ...
        tableZapatoMasVendido = new javax.swing.JTable();
        ...
        jLabel1.setText("Zapato Mas Vendido");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        tableZapatoMasVendido.setBackground(new java.awt.Color(204, 204, 255));
        tableZapatoMasVendido.setForeground(new java.awt.Color(0, 0, 0));
        tableZapatoMasVendido.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tableZapatoMasVendido);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(27, 27, 27)
                        .addComponent(cbGraficas, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
       ChartPanel panel=null;
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            int filas=tableZapatoMasVendido.getRowCount();
            for(int i=0;i<filas;i++){
                String nombre=tableZapatoMasVendido.getValueAt(i, 1).toString();
                double por=Double.parseDouble(tableZapatoMasVendido.getValueAt(i, 3).toString());     
            ...
            for(int i=0;i<filas;i++){
                String nombre=tableZapatoMasVendido.getValueAt(i, 1).toString();
                double por=Double.parseDouble(tableZapatoMasVendido.getValueAt(i, 2).toString());     
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        try{
        ZapatoMasVendidoZ zm = new ZapatoMasVendidoZ(); 
        ...
        int sucursal=zm.numeroSucursal(sucu);
        zm.filtrarZapato(tableZapatoMasVendido, inicio.toString(), fin.toString(), sucursal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZapatoMasVendido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZapatoMasVendido().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableZapatoMasVendido;
