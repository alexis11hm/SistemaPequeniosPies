 ...
 * @author HP-Alexis
 */
public class ProveedorMasVeces extends javax.swing.JFrame {

     DefaultTableModel modeloProveedor=new DefaultTableModel();
     
    public ProveedorMasVeces() {
        initComponents();
        setVisible(true);
        ...
        ProveedorMasVecesP pv = new ProveedorMasVecesP();
        pv.iniciarModeloTabla(modeloProveedor, tableProveedor);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img1/proveedor.png"))); // NOI18N
        jLabel1.setText("   Proveedor Mas Veces Se Le Compra");
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            int filas=tableProveedor.getRowCount();
            for(int i=0;i<filas;i++){
                String nombre=tableProveedor.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableProveedor.getValueAt(i, 2).toString());     
                ...
                JFreeChart chart = ChartFactory.createPieChart(// char t
                                ...
                                "Proveedor Mas Veces Se Le Compra",// title                                                                                                                                        
                                dataset, // data
                                true, // include legend
                                true, false);
            ...
            for(int i=0;i<filas;i++){
                ...
                JFreeChart chart = ChartFactory.createPieChart3D(// char t
                                ...
                                "Proveedor Mas Veces Se Compra",// title                                                                                                                                        
                                dataset, // data
                                true, // include legend
                                true, false);
            ...
            for(int i=0;i<filas;i++){
                String nombre=tableProveedor.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableProveedor.getValueAt(i, 2).toString());     
                dataset.addValue(por, "Proveedores", nombre);
            }
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        int sucursal=pv.numeroSucursal(sucu);
        pv.filtrarProveedor(tableProveedor, inicio.toString(), fin.toString(), sucursal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveedorMasVeces.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProveedorMasVeces().setVisible(true);
            }
        });
    }
