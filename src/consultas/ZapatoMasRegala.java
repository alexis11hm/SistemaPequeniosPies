 ...
 * @author HP-Alexis
 */
public class ZapatoMasRegala extends javax.swing.JFrame {

     DefaultTableModel modeloRegalo=new DefaultTableModel();
     
    public ZapatoMasRegala() {
        initComponents();
        setVisible(true);
        ...
        ZapatoMasRegaladoZ zz = new ZapatoMasRegaladoZ();
        zz.iniciarModeloTabla(modeloRegalo, tableRegalo);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   Zapato Mas Regalado");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGap(204, 204, 204)
                    .addComponent(cbGraficas, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            for(int i=0;i<filas;i++){
                String nombre=tableRegalo.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableRegalo.getValueAt(i, 2).toString());     
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        zz.filtrarRegalo(tableRegalo, inicio.toString(), fin.toString(), sucursal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZapatoMasRegala.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZapatoMasRegala().setVisible(true);
            }
        });
    }
