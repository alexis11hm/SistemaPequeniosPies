 ...
 * @author HP-Alexis
 */
public class ZapatoCompraAlta extends javax.swing.JFrame {

     DefaultTableModel modeloCompra=new DefaultTableModel();
     
    public ZapatoCompraAlta() {
        initComponents();
        setVisible(true);
        ...
        ZapatoCompraAltaZ za = new ZapatoCompraAltaZ();
        za.iniciarModeloTabla(modeloCompra, tableCompra);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("    Zapato Compra Mas Caro");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        tableCompra.setBackground(new java.awt.Color(204, 204, 255));
        tableCompra.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            int filas=tableCompra.getRowCount();
            for(int i=0;i<filas;i++){
                String nombre=tableCompra.getValueAt(i, 1).toString();
                double por=Double.parseDouble(tableCompra.getValueAt(i, 2).toString());     
                ...
                JFreeChart chart = ChartFactory.createPieChart(// char t
                                ...
                                "Zapato Comprado Mas Caro",// title                                                                                                                                        
                                dataset, // data
                                true, // include legend
                                true, false);
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        int sucursal=za.numeroSucursal(sucu);
        za.filtrarCompra(tableCompra, inicio.toString(), fin.toString(), sucursal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZapatoCompraAlta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZapatoCompraAlta().setVisible(true);
            }
        });
    }
