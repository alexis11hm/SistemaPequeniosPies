...
public class ZapatoMasIntercambiado extends javax.swing.JFrame {

     DefaultTableModel modeloIntercambio=new DefaultTableModel();
     
    public ZapatoMasIntercambiado() {
        initComponents();
        setVisible(true);
        ...
        ZapatoMasIntercambio zi = new ZapatoMasIntercambio();
        zi.iniciarModeloTabla(modeloIntercambio, tableIntercambio);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   Zapato Mas Se Intercambia");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        tableIntercambio.setBackground(new java.awt.Color(204, 204, 255));
        tableIntercambio.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jScrollPane1.setViewportView(tableIntercambio);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(37, 37, 37)
                        .addComponent(cbGraficas, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            int filas=tableIntercambio.getRowCount();
            for(int i=0;i<filas;i++){
                String nombre=tableIntercambio.getValueAt(i, 1).toString();
                double por=Double.parseDouble(tableIntercambio.getValueAt(i, 2).toString());     
                ...
                JFreeChart chart = ChartFactory.createPieChart(// char t
                                ...
                                "Zapato Mas Intercambiado",// title                                                                                                                                        
                                dataset, // data
                                true, // include legend
                                true, false);
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        int sucursal=zi.numeroSucursal(sucu);
        zi.filtrarIntercambio(tableIntercambio, inicio.toString(), fin.toString(), sucursal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZapatoMasIntercambiado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZapatoMasIntercambiado().setVisible(true);
            }
        });
    }
