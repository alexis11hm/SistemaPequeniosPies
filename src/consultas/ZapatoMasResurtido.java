 ...
 * @author HP-Alexis
 */
public class ZapatoMasResurtido extends javax.swing.JFrame {

     DefaultTableModel modeloResurtir=new DefaultTableModel();
     
    public ZapatoMasResurtido() {
        initComponents();
        setVisible(true);
        ...
        ZapatoMasResurtidoZ zr = new ZapatoMasResurtidoZ();
        zr.iniciarModeloTabla(modeloResurtir, tableResurtir);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   Zapato Mas Veces Se Resurte");
        ...
        jScrollPane1.setViewportView(tableResurtir);
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            for(int i=0;i<filas;i++){
                String nombre=tableResurtir.getValueAt(i, 1).toString();
                double por=Double.parseDouble(tableResurtir.getValueAt(i, 3).toString());     
                ...
                JFreeChart chart = ChartFactory.createPieChart(// char t
                                ...
                                "Zapato Resurtido Mas Veces",// title                                                                                                                                        
                                dataset, // data
                                true, // include legend
                                true, false);
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        int sucursal=zr.numeroSucursal(sucu);
        zr.filtrarResurtir(tableResurtir, inicio.toString(), fin.toString(), sucursal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZapatoMasResurtido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZapatoMasResurtido().setVisible(true);
            }
        });
    }
