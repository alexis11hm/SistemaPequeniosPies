 ...
 * @author HP-Alexis
 */
public class SucursalMasVenta extends javax.swing.JFrame {

     DefaultTableModel modeloSucursal=new DefaultTableModel();
     
    public SucursalMasVenta() {
        initComponents();
        setVisible(true);
        setLocationRelativeTo(null);
        this.setIconImage(new ImageIcon(getClass().getResource("/imagenes/logo.png")).getImage());
        
        SucursalMasVentaS ss = new SucursalMasVentaS();
        ss.iniciarModeloTabla(modeloSucursal, tableSucursal);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img1/sucursal.png"))); // NOI18N
        jLabel1.setText("   Sucursal Con Mas Ingresos Por Venta");
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            int filas=tableSucursal.getRowCount();
            for(int i=0;i<filas;i++){
                String nombre=tableSucursal.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableSucursal.getValueAt(i, 1).toString());     
                ...
                JFreeChart chart = ChartFactory.createPieChart(// char t
                                ...
                                "Sucursal Mas Ingresos Por Venta",// title                                                                                                                                        
                                dataset, // data
                                true, // include legend
                                true, false);
            ...
            for(int i=0;i<filas;i++){
                ...
                JFreeChart barChart = ChartFactory.createBarChart3D(
                                "Sucursal Mas Ingresos Por Venta",
                                "Sucursal",
                                "Cantidad $",
                                dataset,
            ...
            for(int i=0;i<filas;i++){
                String nombre=tableSucursal.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableSucursal.getValueAt(i, 1).toString());     
                dataset.addValue(por, "Sucursales", nombre);
            }
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        ss.filtrarSucursal(tableSucursal, inicio.toString(), fin.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SucursalMasVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SucursalMasVenta().setVisible(true);
            }
        });
    }
