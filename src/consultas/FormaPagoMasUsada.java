 ...
 * @author HP-Alexis
 */
public class FormaPagoMasUsada extends javax.swing.JFrame {

     DefaultTableModel modeloForma=new DefaultTableModel();
     
    public FormaPagoMasUsada() {
        initComponents();
        setVisible(true);
        ...
        FormaPagoMasUsadaF ff = new FormaPagoMasUsadaF();
        ff.iniciarModeloTabla(modeloForma, tableForma);
    ...
    private void initComponents() {
        ...
        tableForma = new javax.swing.JTable();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img1/factura.png"))); // NOI18N
        jLabel1.setText("  Forma de Pago Mas Utilizada");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        tableForma.setBackground(new java.awt.Color(204, 204, 255));
        tableForma.setForeground(new java.awt.Color(0, 0, 0));
        tableForma.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tableForma);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31)
                        .addComponent(cbGraficas, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            int filas=tableForma.getRowCount();
            for(int i=0;i<filas;i++){
                
                String nombre=tableForma.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableForma.getValueAt(i, 2).toString());     
            ...
            for(int i=0;i<filas;i++){
                String nombre=tableForma.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableForma.getValueAt(i, 2).toString());     
                dataset.addValue(por, "Formas de Pago", nombre);
            }
                JFreeChart lineChart = ChartFactory.createLineChart(
                                "Formas de PAgo Mas Usadas",
                                "Forma de Pago",
                                "Veces Utilizada",
                                dataset,
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        int sucursal=ff.numeroSucursal(sucu);
        ff.filtrarForma(tableForma, inicio.toString(), fin.toString(), sucursal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormaPagoMasUsada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormaPagoMasUsada().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableForma;
