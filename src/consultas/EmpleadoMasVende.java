 ...
 * @author HP-Alexis
 */
public class EmpleadoMasVende extends javax.swing.JFrame {

     DefaultTableModel modeloEmpleado=new DefaultTableModel();
     
    public EmpleadoMasVende() {
        initComponents();
        setVisible(true);
        ...
        EmpleadoMasVendeE e = new EmpleadoMasVendeE();
        e.iniciarModeloTabla(modeloEmpleado, tableEmpleado);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img1/persona.png"))); // NOI18N
        jLabel1.setText("  Empleado Mas Vende");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        tableEmpleado.setBackground(new java.awt.Color(204, 204, 255));
        tableEmpleado.setForeground(new java.awt.Color(0, 0, 0));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(39, 39, 39)
                        .addComponent(cbGraficas, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            int filas=tableEmpleado.getRowCount();
            for(int i=0;i<filas;i++){
                String nombre=tableEmpleado.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableEmpleado.getValueAt(i, 1).toString());     
                ...
                JFreeChart chart = ChartFactory.createPieChart(// char t
                                ...
                                "Empleado Que Mas Veces Vende",// title                                                                                                                                        
                                dataset, // data
                                true, // include legend
                                true, false);
            ...
            for(int i=0;i<filas;i++){
                String nombre=tableEmpleado.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableEmpleado.getValueAt(i, 1).toString());     
                dataset.addValue(por, "Empleados", nombre);
            }
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        int sucursal=e.numeroSucursal(sucu);
        e.filtrarEmpleado(tableEmpleado, inicio.toString(), fin.toString(), sucursal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpleadoMasVende.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpleadoMasVende().setVisible(true);
            }
        });
    }
