 ...
 * @author HP-Alexis
 */
public class ServicioMasGasta extends javax.swing.JFrame {

     DefaultTableModel modeloGasta=new DefaultTableModel();
     
    public ServicioMasGasta() {
        initComponents();
        setVisible(true);
        ...
        ServicioMasGastaS ss = new ServicioMasGastaS();
        ss.iniciarModeloTabla(modeloGasta, tableServicio);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("   Servicio Que Genera Mas Gasto");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        tableServicio.setBackground(new java.awt.Color(204, 204, 255));
        tableServicio.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGap(212, 212, 212)
                    .addComponent(cbGraficas, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botonPastelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPastelActionPerformed
        ...
        DefaultPieDataset dataset = new DefaultPieDataset();
            ...
            int filas=tableServicio.getRowCount();
            for(int i=0;i<filas;i++){
                String nombre=tableServicio.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableServicio.getValueAt(i, 1).toString());     
                ...
                JFreeChart chart = ChartFactory.createPieChart(// char t
                                ...
                                "Servicio Que Genera Mas Gasto",// title                                                                                                                                        
                                dataset, // data
                                true, // include legend
                                true, false);
            ...
            for(int i=0;i<filas;i++){
                String nombre=tableServicio.getValueAt(i, 0).toString();
                double por=Double.parseDouble(tableServicio.getValueAt(i, 1).toString());     
                dataset.addValue(por, "Servicios", nombre);
            }
    ...
    private void botonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConsultarActionPerformed
        ...
        int sucursal=ss.numeroSucursal(sucu);
        ss.filtrarServicio(tableServicio, inicio.toString(), fin.toString(), sucursal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServicioMasGasta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServicioMasGasta().setVisible(true);
            }
        });
    }
